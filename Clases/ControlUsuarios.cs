    ...
    public class ControlUsuarios
    {
        public static bool AltaUsuarioRegistro(string Nombre, string Apaterno, string Amaterno, string striEmailPersonal)
        {
            ...
            try
            {
                ...
                string strBody = EnviarCorreo.Cuerpo("Notificaciones Automaticas", "Alta de Usuario", Nombre + " " + Apaterno + " " + Amaterno, i_usuario, "poc123", "~/assets/HtmlTemplate.html", DateTime.Now, "informacion@iides.info");
